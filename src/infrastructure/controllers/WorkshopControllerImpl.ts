...
export default class WorkshopControllerImpl implements WorkshopController {
  ...
  public async editWorkshop(id: string): Promise<void> {
    try {
      const workshop = new Workshop();
  ...
  public async getMyWorkshops(id: string): Promise<WorkshopModel[]> {
    try {
      const workshop = new Workshop();
  ...
  public async getWorkshop(id: string): Promise<WorkshopModel> {
    try {
      const workshop = new Workshop();
